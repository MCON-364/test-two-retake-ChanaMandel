...
public class ParallelReportBuilder {
    ...
    // TODO 1: declare and initialize private thread-safe progress
    //  tracking state called numberOfBatchesProcessed
    ...
    public ReportSummary generateReport(List<List<Transaction>> batches, int workers)
        ...
        if(batches == null||batches.isEmpty()) throw new IllegalArgumentException();
        ...
        for (List<Transaction> batch : batches) {
            Future<BatchStats> futureStats = executor.submit(()->{
